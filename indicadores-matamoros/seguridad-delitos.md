...
<table class="table table-hover table-bordered matriz">
  ...
  <tbody>
    ...
    <tr><td class="centrado">30/06/2014</td><td class="derecha">230</td><td>Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública</td><td></td></tr>
  </tbody>
</table>
...
<div id="Morrisrzdgaaer" class="grafica"></div>
  <script>
  new Morris.Line({
    element: 'Morrisrzdgaaer',
    data: [
      { fecha: '2014-01-31', dato: 69 },
      { fecha: '2014-02-28', dato: 65 },
      { fecha: '2014-06-30', dato: 230 }
    ],
    xkey: 'fecha',
    ykeys: ['dato'],
    labels: ['Dato'],
