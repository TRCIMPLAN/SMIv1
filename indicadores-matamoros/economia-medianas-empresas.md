...
<table class="table table-hover table-bordered matriz">
  ...
  <tbody>
    ...
    <tr><td class="centrado">31/07/2014</td><td class="derecha">1.73 %</td><td>Sistema de Información Empresarial Mexicano (SIEM)</td><td></td></tr>
  </tbody>
</table>
...
<div id="Morrisyucjsvvc" class="grafica"></div>
  // Gráfica
  if (typeof varMorrisyucjsvvc === 'undefined') {
    varMorrisyucjsvvc = Morris.Line({
      element: 'Morrisyucjsvvc',
