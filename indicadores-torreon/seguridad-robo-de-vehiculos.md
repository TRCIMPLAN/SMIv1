...
<table class="table table-hover table-bordered matriz">
  ...
  <tbody>
    ...
    <tr><td class="centrado">31/10/2014</td><td class="derecha">101</td><td>Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública</td><td></td></tr>
    <tr><td class="centrado">30/11/2014</td><td class="derecha">71</td><td>Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública</td><td></td></tr>
  </tbody>
</table>
...
<script>
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2014-01-31', dato: 135 },{ fecha: '2014-02-28', dato: 92 },{ fecha: '2014-03-31', dato: 70 },{ fecha: '2014-04-30', dato: 82 },{ fecha: '2014-05-31', dato: 115 },{ fecha: '2014-06-30', dato: 95 },{ fecha: '2014-07-31', dato: 83 },{ fecha: '2014-08-31', dato: 96 },{ fecha: '2014-09-30', dato: 97 },{ fecha: '2014-10-31', dato: 101 },{ fecha: '2014-11-30', dato: 71 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
