...
<table class="table table-hover table-bordered matriz">
  ...
  <tbody>
    <tr><td class="centrado">31/12/2012</td><td class="derecha">4.6</td><td>SINAIS (SSA)</td><td>Dirección General de Información en Salud (DGIS). Base de datos de defunciones generales 1979-2007. [en línea]: Sistema Nacional de Información en Salud (SINAIS). [México]: Secretaría de Salud. <http://www.sinais.salud.gob.mx> [Consulta: 01 abril 2014].</td></tr>
  </tbody>
</table>
