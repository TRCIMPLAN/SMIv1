...
<table class="table table-hover table-bordered matriz">
  ...
  <tbody>
    <tr><td class="centrado">31/12/2013</td><td class="derecha">88.61 %</td><td>Sistema de Información Empresarial Mexicano (SIEM)</td><td></td></tr>
...
<div id="Morristtkpbzsq" class="grafica"></div>
  // Gráfica
  if (typeof varMorristtkpbzsq === 'undefined') {
    varMorristtkpbzsq = Morris.Line({
      element: 'Morristtkpbzsq',
