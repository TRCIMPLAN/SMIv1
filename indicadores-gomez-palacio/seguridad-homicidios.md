...
<table class="table table-hover table-bordered matriz">
  ...
  <tbody>
    <tr><td class="centrado">31/01/2014</td><td class="derecha">12</td><td>Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública</td><td></td></tr>
    <tr><td class="centrado">28/02/2014</td><td class="derecha">10</td><td>Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública</td><td></td></tr>
    <tr><td class="centrado">31/03/2014</td><td class="derecha">8</td><td>Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública</td><td></td></tr>
    ...
    <tr><td class="centrado">31/10/2014</td><td class="derecha">12</td><td>Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública</td><td></td></tr>
    <tr><td class="centrado">30/11/2014</td><td class="derecha">11</td><td>Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública</td><td></td></tr>
  </tbody>
</table>
...
<script>
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2014-01-31', dato: 12 },{ fecha: '2014-02-28', dato: 10 },{ fecha: '2014-03-31', dato: 8 },{ fecha: '2014-04-30', dato: 17 },{ fecha: '2014-05-31', dato: 10 },{ fecha: '2014-06-30', dato: 19 },{ fecha: '2014-07-31', dato: 11 },{ fecha: '2014-08-31', dato: 4 },{ fecha: '2014-09-30', dato: 9 },{ fecha: '2014-10-31', dato: 12 },{ fecha: '2014-11-30', dato: 11 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
