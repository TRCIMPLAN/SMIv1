GOMEZ PALACIO, INGRESOS PROPIOS POR COBRO DE SERVICIOS
=====
...
<div id="Morrisoqgkknrw" class="grafica"></div>
  <!-- JAVASCRIPT DE LA GRAFICA EN Morrisoqgkknrw -->
  <script>
  new Morris.Bar({
    element: 'Morrisoqgkknrw',
    data: [
