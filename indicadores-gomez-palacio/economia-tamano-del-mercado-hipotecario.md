...
<table class="table table-hover table-bordered matriz">
  ...
  <tbody>
    ...
    <tr><td class="centrado">31/12/2012</td><td class="derecha">1,030</td><td>Comisión Nacional Bancaria y de Valores (CNBV)</td><td></td></tr>
...
<div id="Morrisgscwuavb" class="grafica"></div>
  // Gráfica
  if (typeof varMorrisgscwuavb === 'undefined') {
    varMorrisgscwuavb = Morris.Line({
      element: 'Morrisgscwuavb',
