...
<div id="Morrisjizvqdor" class="grafica"></div>
  <!-- JAVASCRIPT DE LA GRAFICA EN Morrisjizvqdor -->
  <script>
  new Morris.Line({
    element: 'Morrisjizvqdor',
    data: [
      { fecha: '1998-12-31', dato: 12.8400 },
      { fecha: '2003-12-31', dato: 12.5800 },
      { fecha: '2008-12-31', dato: 8.3300 }
    ],
    xkey: 'fecha',
    ykeys: ['dato'],
    labels: ['Dato'],
